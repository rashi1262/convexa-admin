...
import { auth, provider, signInWithPopup } from "../../firebase.js"; // Import Firebase auth methods
import { toast } from 'sonner';
import { BASE_URL } from '../../common/siteConstants';
import axios from 'axios';
import { useAuth } from '../../common/ProtectedRoutes.js';  // Import the useAuth hook
...
const SignIn: React.FC = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      const user = await signInWithPopup(auth, provider).then(result => result.user);
      ...
      if (res?.data?.user) {
        ...
        // Call login function from AuthContext to set authentication state
        login(res.data.user);  // Pass the user data here
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Welcome to Convexa AI Admin Dashboard — your control center for managing tools, partners, categories, and more.
                Sign in to access powerful insights, streamline operations, and unlock the full potential of Convexa AI.
              </p>
